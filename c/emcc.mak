...
eclipse.html: $(l).a $(l)d.a  eclipse.o  $(user-objects)
	if [ `uname -s` = "HP-UX" ]; then LIBDL=dld; else LIBDL=dl; fi; \
	$(CC) $(CFLAGS) $(LDFLAGS) -L. eclipse.o -o eclipse.html $(user-objects) -leclipse -leclipsed -lm -l$$LIBDL -lgc

eclipse.js: $(l).a $(l)d.a  eclipse.o  $(user-objects)
	if [ `uname -s` = "HP-UX" ]; then LIBDL=dld; else LIBDL=dl; fi; \
	$(CC) $(CFLAGS) $(LDFLAGS) -L. eclipse.o -o eclipse.js $(user-objects) -leclipse -leclipsed -lm -l$$LIBDL -lgc
